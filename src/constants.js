...
export const SUCCESS_MESSAGES = {
  ...
  FONT_ADDED: "Police ajoutée avec succès",
  FONT_DELETED: "Police supprimée avec succès",
};

// Formats de polices valides
export const VALID_FONT_FORMATS = ["font/woff2", "font/woff", "font/ttf", "font/otf", "application/x-font-woff", "application/x-font-ttf"];
...
export const ERROR_MESSAGES = {
  ...
  INVALID_FONT_FORMAT: "Format de police non supporté (woff2, woff, ttf, otf uniquement)",
